 ...
 */
public class AutofitTextView extends CustomFontTextView implements AutofitHelper.OnTextSizeChangeListener {

    private AutofitHelper mHelper;

    /**
     * Instantiates a new Autofit text view.
     *
     ...
     *
     * @param sizeToFit the size to fit
     */

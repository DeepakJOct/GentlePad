...
public class AutofitHelper {
     ...
     * @see TextView#getMaxLines() TextView#getMaxLines()
     */
     ...
     * @return the max lines
     * @see TextView#setMaxLines(int) TextView#setMaxLines(int)
     */
     ...
     * @see TextView#getTextSize() TextView#getTextSize()
     */
     ...
     *
     * @param size the size
     * @see TextView#setTextSize(float) TextView#setTextSize(float)
     */
     ...
     * @param unit the unit
     * @param size the size
     * @see TextView#setTextSize(int, float) TextView#setTextSize(int, float)
     */
    ...
    public interface OnTextSizeChangeListener {
         ...
         * @param oldTextSize the old text size
         */
